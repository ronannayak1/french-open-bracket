...
User brackets are stored under `usopen2026/brackets/{userId}`. Official results are stored under `usopen2026/official`. These are **sibling** paths: updating `official` does not read or write `brackets`.
